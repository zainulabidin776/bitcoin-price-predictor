...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/system-overview.png}
\caption{System Architecture Diagram - Complete MLOps Pipeline}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/docker-services.png}
\caption{Docker Compose services running successfully}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/airflow-dag.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/data-extraction.png}
\caption{Successful data extraction from CryptoCompare API}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/quality-check.png}
\caption{Data quality check results showing all gates passed}
\label{fig:quality-check}
\end{figure}

\subsubsection{Feature Engineering}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/feature-engineering.png}
\caption{Feature engineering output with 36 features}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/mlflow-experiments.png}
\caption{MLflow experiments tracked in DagHub}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/model-metrics.png}
\caption{Model performance metrics (RMSE, MAE, R², MAPE)}
\label{fig:model-metrics}
\end{figure}

\subsubsection{DagHub Central Hub}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/dagshub-hub.png}
\caption{DagHub showing integrated Code, Data, and Models}
\label{fig:dagshub-hub}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/github-actions.png}
\caption{GitHub Actions CI/CD pipeline execution}
\label{fig:github-actions}
\end{figure}

\subsubsection{CML Model Comparison}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/cml-comparison.png}
\caption{CML automatic model comparison report in PR}
\label{fig:cml-comparison}
\end{figure}

\subsection{API and Deployment}

\subsubsection{FastAPI Documentation}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/fastapi-docs.png}
\caption{FastAPI Swagger documentation interface}
\label{fig:fastapi-docs}
\end{figure}

\subsubsection{API Health Check}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/api-health.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/prediction-endpoint.png}
\caption{Prediction endpoint with drift detection}
\label{fig:prediction-endpoint}
\end{figure}

\subsection{Monitoring and Observability}

\subsubsection{Prometheus Targets}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/prometheus-targets.png}
\caption{Prometheus targets showing API as UP}
\label{fig:prometheus-targets}
\end{figure}

\subsubsection{Prometheus Queries}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/prometheus-queries.png}
\caption{Prometheus query results showing metrics data}
\label{fig:prometheus-queries}
\end{figure}

\subsubsection{Grafana Dashboard}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/grafana-dashboard.png}
\caption{Grafana monitoring dashboard with multiple panels}
\label{fig:grafana-dashboard}
\end{figure}

\subsubsection{Grafana Data Source}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/grafana-datasource.png}
\caption{Grafana Prometheus data source configuration}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/grafana-alerts.png}
\caption{Grafana alert rules configuration}
\label{fig:grafana-alerts}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/minio-console.png}
\caption{MinIO console showing mlops-data bucket}
\label{fig:minio-console}
\end{figure}

\subsubsection{DVC Data Versioning}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/dvc-versioning.png}
\caption{DVC data versioning with MinIO remote}
\label{fig:dvc-versioning}
\end{figure}
...
\centering
\includegraphics[width=0.9\textwidth]{screenshots/system-overview.png}
\caption{Complete system architecture overview}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{screenshots/service-dependencies.png}
\caption{Docker Compose service dependencies}
